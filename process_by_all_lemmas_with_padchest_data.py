...
class ExecClass:
  ...
  def exec(self):
    ...
    data_from_babelnet = self.babelTermsMatcher.get_data_from_list_of_lemmas_default_all ( self.config_data['lemma_list'], self.config_data['lang'], self.config_data['search_levels'])
